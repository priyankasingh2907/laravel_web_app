 ...
 <section class="hero">
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                            ...
                            <div class="row align-items-center d-flex h-100">
                                <div class="col-md-7">
                                    <div class="block" >
                                        ...
                                        <h1 class="mb-3 mt-3">If you love life, dont waste time, for time is what life is made up of</h1>                                        
                                        <p class="mb-4 pr-5">A repudiandae ipsam labore ipsa voluptatum quidem quae laudantium quisquam aperiam maiores sunt fugit, deserunt rem suscipit placeat.</p>
                                        <div class="btn-container ">
                                            <a href="{{('contacts')}}" target="_blank" class="btn btn-primary">Contact Now <i class="icofont-simple-right ml-2  "></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="carousel-item "style="background-image: url('assets/images/banner1.jpg') ;">
                        <div class="hero-background-overlay"></div>
                        <div class="container h-100">
                            <div class="row align-items-center d-flex h-100">
                                <div class="col-md-7">
                    ...
                    <div class="carousel-item" style="background-image: url('assets/images/banner24.jpg') ;">
                        <div class="hero-background-overlay"></div>
...
@foreach($services as $service)
                        ...
                        <div class="card border-0 ">
                            <img src="{{  asset('uploads/temp/'.$service->Image)}}" class="card-img-top" alt="">
        ...
        <section class="section-4 py-5 text-center">
            ...
            <div class="container">
               <div class="help-container">
                    ...
                    <a href="/contacts" class="btn btn-primary mt-3">Call Us Now <i class="fa-solid fa-angle-right"></i></a>
               </div>
            </div>
        </section>
