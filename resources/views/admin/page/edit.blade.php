...
@endif
                ...
                <form enctype="multipart/form-data" action="{{ route('page.update',$page->id)}}" method="post" name="editpageForm" id="createpageForm">
                @csrf    
                <div class="card">
                ...
                <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                   ...
                                   <img class="text-center" src="{{ asset('uploads/temp/'.$page->Image) }}" alt="image" width="200px" height="200px" />
                        ...
                        <div class="form-group m-2">
                            ...
                            <option value="1"  {{ ($page->active) == 1 ? 'selected' : ''}}>Active</option>
                            <option value="0"  {{ ($page->active) == 0 ? 'selected' : ''}}>Block</option>
                            </select>
                        </div>
                        <div class="form-group m-2">
