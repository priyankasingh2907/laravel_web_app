                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <a href="{{ route('page.create') }}" class="btn btn-primary">Create</a>
                        </div>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <img src="{{ asset('uploads/temp/'.$pages->image)}}" alt="image" width="50">
                                </td>
                                <td>{{ $pages->name }}</td>
                                <td>{{ $pages->content }}</td>
                                ...
                                <td>
                                    <a href="{{ route('page.edit', $pages->id) }}" class="btn btn-primary">Edit</a>
                                </td>
                                <td>
                                <a href="{{route('page.delete' , $pages->id)  }}" onclick="return myFunction();" class="btn btn-danger" >Delete</a>
                               </td>  
                             </tr>
                             @endforeach
                            @else
