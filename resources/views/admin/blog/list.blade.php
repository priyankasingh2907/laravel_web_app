                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <img src="{{ asset('uploads/temp/'.$Blogs->Image)}}" alt="image" width="50">
                                </td>
                                <td>{{ $Blogs->name }}</td>
                                ...
                                <td>
                                    <a href="{{ route('blog.edit', $Blogs->id) }}" class="btn btn-primary">Edit</a>
                                </td>
                                <td>
                                <a href="{{route('blog.delete' , $Blogs->id)  }}" onclick="return myFunction();" class="btn btn-danger" >Delete</a>
                               </td>  
                             </tr>
                             @endforeach
                            @else
